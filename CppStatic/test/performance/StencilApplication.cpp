...
namespace Haparanda {
	...
	private:
		typedef ConstFD8Stencil<DIMENSIONALITY> OperatorType;
		typedef ComputationalComposedBlock<DIMENSIONALITY> InputBlockType;
		typedef ComputationalPureBlock<DIMENSIONALITY> OutputBlockType;
	...
	StencilApplication<DIMENSIONALITY>::StencilApplication(std::size_t pointsPerUnit) {
		...
		// One unit per block
		inputBlock = new InputBlockType(pointsPerUnit, ORDER_OF_ACCURACY/2);
		...
		resultBlock = new OutputBlockType(pointsPerUnit, resultValues);
