...
namespace Iterators {
	...
	protected:
		typedef ValueFieldBoundaryIterator<FIELD_ORDER> IteratorType;
	...
	protected:
		...
		void testCurrentNeighbor() {
			FieldIteratorTest::testCurrentNeighbor_outside_boundary(iterator);
		}
		...
		void testSetCurrentNeighbor() {
			FieldIteratorTest::testSetCurrentNeighbor_outside_boundary(iterator);
		}
