...
protected:
	typedef typename ComputationalPureBlock<DIM>::InnerIteratorType InnerIteratorType;
	typedef typename ComputationalPureBlock<DIM>::BoundaryIteratorType BoundaryIteratorType;
	...
	void testConstructor() {
		...
		FieldIterator<InnerIteratorType> *iterator = blockWithoutIndexBlock.getInnerIterator();
		// Verify (first) value
		iterator->first();
