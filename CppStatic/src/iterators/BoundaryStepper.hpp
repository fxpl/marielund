...
namespace Iterators {
	...
	class BoundaryStepper: public FieldSteppingStrategy<BoundaryStepper<DIMENSIONALITY>>
	{
	public:
		/**
	...
	protected:
		...
		template<class IteratorType> friend class FieldIterator;
		friend class FieldSteppingStrategy<BoundaryStepper<DIMENSIONALITY>>;
	...
	: FieldSteppingStrategy<BoundaryStepper<DIMENSIONALITY>>(sizes) {
	}
